...
<html>
<head>
<title>STW | Admin manage Bookings</title>
...
<?php }?>
 ...
 <h2>Top Booked Tour Packages</h2>
...
<table>
    ...
    $sql = "CALL GetTopBookedTourPackage()"; // Assuming the name of your stored procedure is GetTopBookedTourPackages
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>" . $row["PackageName"] . "</td><td>" . $row["TotalBookings"] . "</td></tr>";
        }
    } else {
