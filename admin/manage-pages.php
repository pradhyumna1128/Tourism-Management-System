  ...
  <div class="grid-form1">
  	       <h3>Update Page Data</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="manage-pages.php?type=Terms_and_Conditions">terms and condition</option>
                  <option value="manage-pages.php?type=Privacy_Policy">privacy and policy</option>
                  <option value="manage-pages.php?type=About_Us">About Us</option> 
                  <option value="manage-pages.php?type=Contact_Us">Contact Us</option>
                </select>
									</div>
								</div>
<div class="form-group">
