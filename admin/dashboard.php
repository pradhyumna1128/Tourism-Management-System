...
<script>
// JavaScript code to handle the response from the server and show a popup alert
function checkForNewBooking(response) {
    if (response.newBooking){
        // Show a popup alert
        alert("A new booking has been made!");
    }
}

// Make an AJAX request to the server to check for new bookings
// You can trigger this function periodically or when the page loads
$(document).ready(function() {
    $.ajax({
        url: 'check_for_new_booking.php', // PHP file that handles the request
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            checkForNewBooking(response);
        },
...
$cnt3=$query3->rowCount();
	...
	<div class="four-grids">
			<div class="col-md-4 four-grid">
						<div class="four-agileinfo FOUR3">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
<div class="clearfix"></div>
	...
	<a href="manage-bookings.php">
						...
						<div class="four-agileinfo FOUR6">
							<div class="icon">
